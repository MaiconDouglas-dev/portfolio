        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="space-y-1.5">
              <h1 className="text-4xl sm:text-6xl font-black tracking-tight text-neutral-900 dark:text-white leading-[1.08]">
                Maicon Douglas
              </h1>
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-5 py-3 rounded-xl border border-neutral-300 dark:border-white/[0.1] bg-white/80 dark:bg-black/80 text-neutral-700 dark:text-neutral-200 font-semibold text-xs hover:border-appleRed-500/40 hover:text-white transition-all cursor-pointer backdrop-blur-md"
              >
              ...
              <div className="flex items-center gap-1.5 pl-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2.5 rounded-lg border border-neutral-200 dark:border-white/[0.08] text-neutral-500 hover:text-white hover:border-white/20 transition-all"
                >
                  <Github size={16} />
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2.5 rounded-lg border border-neutral-200 dark:border-white/[0.08] text-neutral-500 hover:text-appleBlue-400 hover:border-appleBlue-500/30 transition-all"
                >
                  <Linkedin size={16} />
                </a>
                <a
                  href="mailto:maicondouglasdev1@gmail.com"
                  className="p-2.5 rounded-lg border border-neutral-200 dark:border-white/[0.08] text-neutral-500 hover:text-appleRed-400 hover:border-appleRed-500/30 transition-all"
                >
                  <Mail size={16} />
                </a>
              </div>
          ...
          {/* Right Column: Sleek Compact Terminal */}
